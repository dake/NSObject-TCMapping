...
@property (nonatomic, strong) TCWeiboPictureMetadata *thumbnail;
@property (nonatomic, strong) TCWeiboPictureMetadata *bmiddle;
@property (nonatomic, strong) TCWeiboPictureMetadata *middlePlus;
@property (nonatomic, strong) TCWeiboPictureMetadata *large;
@property (nonatomic, strong) TCWeiboPictureMetadata *largest;
...
@property (nonatomic, strong) NSDate *createdAt;
@property (nonatomic, strong) TCWeiboUser *user;
@property (nonatomic, assign) int32_t userType;
@property (nonatomic, strong) NSString *text;
@property (nonatomic, strong) NSArray *picIds;        /// Array<NSString>
@property (nonatomic, strong) NSDictionary *picInfos; /// Dic<NSString, TCWeiboPicture>
