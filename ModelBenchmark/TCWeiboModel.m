...
+ (TCMappingOption *)tc_mappingOption
{
    ...
    if (nil == opt) {
        ...
        opt.propertyNameMapping = @{@"cutType" : @"cut_type"};
    }
...
+ (TCMappingOption *)tc_mappingOption
{
    ...
    if (nil == opt) {
        opt = [[TCMappingOption alloc] init];
        opt.propertyNameMapping = @{@"picID" : @"pic_id",
                                    @"keepSize" : @"keep_size",
                                    @"photoTag" : @"photo_tag",
                                    @"objectID" : @"object_id",
...
+ (TCMappingOption *)tc_mappingOption
{
    ...
    if (nil == opt) {
        opt = [[TCMappingOption alloc] init];
        opt.propertyNameMapping = @{@"oriURL" : @"ori_url",
                                    @"urlTitle" : @"url_title",
...
+ (TCMappingOption *)tc_mappingOption
{
    ...
    if (nil == opt) {
        opt = [[TCMappingOption alloc] init];
        opt.propertyNameMapping = @{@"userID" : @"id",
                                    @"idString" : @"idstr",
                                    @"genderString" : @"gender",
...
+ (TCMappingOption *)tc_mappingOption
{
    ...
    if (nil == opt) {
        opt = [[TCMappingOption alloc] init];
        opt.propertyNameMapping = @{@"statusID" : @"id",
                                    @"createdAt" : @"created_at",
